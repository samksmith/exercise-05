...
plotDist("norm",mean = mean(z$zombies_killed),sd = sd(z$zombies_killed),add=TRUE) # zombies killed seems normally distributed
...
# perhaps a poisson distribution (this is discrete var) or binomial?
```
...
(sampling_distr_means_sds <- z_sampled200 %>% summarize(sampdistr_mean_height = mean(mean_height),
                                                       samp_distr_sd_height = sd(mean_height),
                                                       ...
                                                       sampdistr_yearsed = mean(mean_yearsed),
                                                       sampdistr_yearsed = sd(mean_yearsed)))
